---
title: "Netherlands in 2026: Expat Guide to the 30% Ruling, Visas & Rent"
description: "Moving to the Netherlands in 2026? A complete expat guide covering the updated 30% tax ruling, language exam changes, and the intense housing market."
date: "2026-06-09"
tags: ["netherlands", "seo-geo", "relokacja", "cost-of-living", "taxes"]
coverImage: "/images/blog/moving-to-netherlands-expat-guide.jpg"
...
| Category | Monthly Salary Threshold (2026) |
|----------|--------------------------------|
...
| Prior residence | Must have lived **more than 150km from Dutch border** for at least 16 of the 24 months before starting work in NL[^14] |
| Application deadline | Within **4 months** of starting work — otherwise no retroactive application[^14] |
| Maximum salary cap | **€262,000/year** — the ruling does not apply to income above the WNT norm[^14][^15] |
| Duration | Maximum **5 years**[^14] |

**Transitional rules apply based on when the ruling started:**[^16]

| Ruling started | 30% or 27%? | Partial foreign tax liability? |
|----------------|-------------|-------------------------------|
| On or before 31 Dec 2023 | **30% until end of 5-year period** | Until 2027 (transition) |
| In 2024 | **30% through 2026; 27% from 2027** | Abolished from 2025 |
| From 1 Jan 2025 | **30% through 2026; 27% from 2027** + higher salary criterion from 2027 | Abolished from 2025 |
...
| City | 1-BR (Centre) | 1-BR (Outside) | Total Single (incl. rent) |
|------|--------------|----------------|--------------------------|
...
| Bracket | Income Range | Combined Rate (2026) |
|---------|-------------|---------------------|
| 1 | Up to €38,883 | **35.75%** (includes 27.65% national insurance)[^24] |
| 2 | €38,883 – €78,426 | **37.56%**[^24][^23] |
| 3 | Above €78,426 | **49.50%**[^24][^23] |
...
| GP consultation deductible | **Free — GP visits no longer count toward deductible from 2026**[^27] |
...
|------|-------------|--------------|----------------------|
| The Hague | 20.0 | **80.0** | Top 10 Europe[^4] |
| Eindhoven | 20.9 | **79.1** | Top 15 Europe[^4] |
| Utrecht | 22.0 | **78.0** | — |
| Groningen | 22.1 | **77.9** | — |
| Rotterdam | 26.3 | 73.7 | — |
| Amsterdam | 26.4 | 73.6 | — |
...
|--------|---------------|
| Civic integration (inburgering) completion | **B1** (most routes, arrived after 2022)[^35] |
| Permanent residency (standard) | **A2** (current) — B1 widely expected to become the requirement; apply at A2 before the change[^34] |
| Dutch citizenship | **A2** (current) — same advisory applies[^34] |
...
| City | 1-BR Rent (Centre) | Key Sector | Safety Index 2026 | Best For |
|------|--------------------|------------|-------------------|----------|
| Amsterdam | €2,030[^18] | Finance/Tech/Creative | 73.6[^31] | EU HQ roles, creative industries |
| Rotterdam | €1,447[^1] | Logistics/Port/Architecture | 73.7[^31] | Shipping, logistics, value |
| The Hague | €1,600[^18] | Government/International Law | **80.0**[^4] | IGOs, diplomats, legal |
| Utrecht | €1,515[^1] | Academia/Tech | 78.0[^31] | Research, central location |
| Eindhoven | €1,348[^1] | Semiconductor/Manufacturing | 79.1[^4] | Engineers, ASML, HSMP |
| Groningen | €1,976[^1] | Academia/Energy Transition | 77.9[^31] | Students, researchers |
...
| Season | Months | Temperature | Condition |
|--------|--------|-------------|-----------|
| Spring | March–May | 8–17°C | Mixed; improves late April |
| Summer | June–August | 18–24°C | Best period; long evenings; pleasant |
| Autumn | September–November | 7–15°C | Cooling; increasing rain and wind |
| Winter | December–February | 1–7°C | Mild; rarely severe; grey and damp |
...
| 30% Ruling rate in 2026 | **30%** (reduced to 27% from 2027)[^14] |
| 30% Ruling salary cap | **€262,000/year**[^14] |
| Box 1 Top Tax Rate | **49.50%** (income above €78,426)[^24] |
| Box 1 Bracket 1 Rate | **35.75%** (up to €38,883)[^24] |
...
| Inburgering language requirement | **B1** (current); A2 for PR/citizenship (change expected)[^34] |
| Permanent Residency | 5 years + A2 (apply before B1 change)[^34] |
| Citizenship | 5 years + A2 (same) + **renounce original nationality**[^37] |
| National Crime Index 2026 | **25.5 — Low** (all-time lowest)[^30] |
| The Hague Safety Index | **80.0**[^4] |
...
| Amsterdam overbid rate | 65–70% of homes above asking[^2] |
| Transfer Tax (own use) | **2%** (0% for first-time buyers under 35)[^39] |
| Gigabit Fibre (monthly) | €35–55[^21] |
| Emergency | **112 (ambulance/fire/police)**[^29] |
...
1. [Average Rental Prices in the Netherlands by City (2026) | RentBuzz](https://www.rentbuzz.nl/en/blog/average-rental-prices-netherlands-2026) - Compare average rental prices in Amsterdam, Rotterdam, The Hague, Utrecht, Groningen and Eindhoven. ...

2. [Amsterdam Real Estate Market Analysis (2026) - Investropa](https://investropa.com/blogs/news/amsterdam-real-estate-market) - As of early 2026, properties in Amsterdam typically sell for about 6% to 7% above the asking price, ...
...
6. [Economic forecast for Netherlands - Economy and Finance](https://economy-finance.ec.europa.eu/economic-surveillance-eu-economies/netherlands/economic-forecast-netherlands_en) - The latest macroeconomic forecast for Netherlands.

7. [OECD Economic Outlook, Volume 2025 Issue 1: Netherlands](https://www.oecd.org/en/publications/2025/06/oecd-economic-outlook-volume-2025-issue-1_1fd979a8/full-report/netherlands_d5beccd6.html) - The global outlook is becoming increasingly challenging. Substantial increases in barriers to trade ...

8. [Expat Guide: Guide for Expats moving to the Netherlands](https://www.expatguide.nl) - An index of quality businesses and services with English speaking staff to help make moving to and l...

9. [Salary Thresholds Highly Skilled Migrants 2026 - All About Expats](https://allaboutexpats.nl/salary-thresholds-hsm/) - Highly skilled migrant salary thresholds for 2026. Learn about IND income requirements, reduced crit...

10. [2026 Salary Thresholds: Highly Skilled Migrants & EU Blue ...](https://www.executivemobility-group.com/2026-salary-thresholds-highly-skilled-migrants-netherlands/) - Official 2026 salary thresholds for Highly Skilled Migrants and EU Blue Card holders in the Netherla...

11. [New threshold amounts for Expats and Highly Skilled ...](https://www.bakertilly.nl/en/inzichten/kennisartikel/new-threshold-amounts-for-expats-and-highly-skilled-migrants-in-2026) - Several thresholds and salary criteria for residence permits and the 30% ruling have changed. Our ex...

12. [Netherlands: 2026 Salary Thresholds & Sponsor Requirements](https://tandslaw.com/netherlands-2026-salary-thresholds-sponsor-requirements/)

13. [30% ruling: compensation for expats down to 27% | Business.gov.nl](https://business.gov.nl/amendments/30-percent-ruling-compensation-down-to-27-percent/) - Do you use the 30% ruling? The maximum tax benefit will be 27% from 2027. Read how the expat facilit...

14. [Expat ruling 2026–2027: de belangrijkste wijzigingen - Forvis Mazars](https://www.forvismazars.com/nl/en/who-we-are/news-events-and-publications/news/dutch-expat-ruling-in-2026-and-2027) - De expatregeling verandert in 2026 en 2027. Lees welke regels voor u gelden en welke stappen u nu ku...

15. [Netherlands 2026 Salary Thresholds for Highly Skilled Migrants ...](https://www.executivemobility-group.com/provisisalary-thresholds-for-highly-skilled-migrants-2026-provisional-figures/) - See the projected 2026 salary thresholds for highly skilled migrants and the updated 30 percent ruli...

16. [Changes in 30% facility now final | EY - Netherlands](https://www.ey.com/en_nl/technical/tax/tax-updates/changes-in-30-percent-facility-now-final) - With both the House of Representatives and the Senate having given their approval for the Tax Plan 2...

17. [Netherlands - Individual - Significant developments](https://taxsummaries.pwc.com/netherlands/individual/significant-developments) - Detailed description of significant developments in individual taxation in Netherlands

18. [Netherlands Cost of Living 2026 — Expat Data | WTE](https://wheretoemigrate.io/countries/netherlands-cost-of-living-2026) - Detailed cost of living comparison across 3 cities in Netherlands. Rent, monthly budgets for singles...

19. [Addressing high rents: the impact of the Netherlands' Affordable ...](https://www.housingeurope.eu/addressing-high-rents-the-impact-of-the-netherlands-affordable-rent-act-on-tenants-and-the-housing-market/) - The government expects that for more than 300.000 homes, the rent will drop by an average of € 190 p...
...
23. [Tax brackets for income tax will change in 2026 - Business.gov.nl](https://business.gov.nl/amendments/income-tax-brackets-change-in-2026/) - The tax brackets and tariffs for the income tax will change in 2026. Read more

24. [Dutch Tax Budget 2026 – rates and tax credits - Deloitte](https://www.deloitte.com/nl/en/services/tax/blogs/pakket-belastingplan-2026-tarieven-heffingskortingen.html) - On 16 September 2025, the Dutch Ministry of Finance published the government’s tax plan for 2026. In...

25. [Netherlands - Individual - Taxes on personal income](https://taxsummaries.pwc.com/netherlands/individual/taxes-on-personal-income) - Detailed description of taxes on individual income in Netherlands

26. [Health insurance allowance in the Netherlands (zorgtoeslag)](https://www.iamexpat.nl/expat-info/social-security/health-insurance-allowance-netherlands) - The government provides a health insurance allowance in the Netherlands (zorgtoeslag) to help people...

27. [Healthcare Insurance in the Netherlands: What's Changing in 2026?](https://www.expatrepublic.com/healthcare-insurance-netherlands-2026/) - As with every year, there are always changes. Here is the lowdown on what is changing in healthcare ...

28. [What is zorgtoeslag? Guide to getting healthcare allowance](https://housinganywhere.com/Netherlands/healthcare-allowance-netherlands) - Discover what’s zorgtoeslag, how to apply, and who is eligible for healthcare benefits in the Nether...

29. [Netherlands cost of living calculator 2026 - NLCompass](https://www.nlcompass.com/calculators/cost-of-living-calculator) - €2,450/month Amsterdam, €1,950 Rotterdam, €2,200 Utrecht. Health insurance €159, rent, groceries, tr...
...
33. [Civic integration (inburgering) in the Netherlands | Government.nl](https://www.government.nl/themes/migration-and-travel/integration-in-the-netherlands/civic-integration-in-the-netherlands) - People who move to the Netherlands permanently or for a longer period can take part in the civic int...

34. [Dutch integration exam: Do you need language level A2 or B1?](https://www.iamexpat.nl/education/education-news/dutch-integration-exam-do-you-need-language-level-a2-or-b1) - Learn which Dutch language level you need for permanent residence or citizenship in 2026 and how to ...

35. [Dutch language Netherlands 2026 | B1 inburgering €350-400](https://www.nlcompass.com/guides/language-integration-netherlands-expats) - B1 Dutch now required for most residence permits and naturalization (2022 Act) · 3-year deadline fro...

36. [Seeking Advice on A2/B1 Requirements for 2027 Citizenship ...](https://www.reddit.com/r/learndutch/comments/1pxouas/seeking_advice_on_a2b1_requirements_for_2027/) - I need to apply for citizenship around the end of 2027 (Q4). Should I already start working on the A...

37. [Becoming a Dutch national through naturalisation - IND](https://ind.nl/en/dutch-citizenship/becoming-a-dutch-national-through-naturalisation) - Requirements · You must be 18 years or older. · You can prove your identity and nationality with val...

38. [Civic integration for more secure residence permit and naturalisation](https://ind.nl/en/living-in-the-netherlands-with-a-residence-permit/civic-integration-for-more-secure-residence-permit-and-naturalisation) - You usually have to fulfil the integration requirement. That means you first have to pass the civic ...

39. [The Netherlands' Residential Property Market Analysis 2026](https://www.globalpropertyguide.com/europe/netherlands/price-history) - In Q1 2026, the average purchase price increased further to EUR 492,199 (USD 576,020), up 4.72% comp...

40. [The Dutch housing market is stabilising, and that is good news](https://www.iamexpat.nl/housing/property-news/the-dutch-housing-market-stabilising-and-good-news) - Dutch housing market stabilises with falling prices and more supply. Learn about mortgage rates, fou...


---
*Cover photo by [Sven Schulze](https://www.pexels.com/photo/symmetrical-view-of-the-canal-and-buildings-in-amsterdam-the-netherlands-20763246/) on [Pexels](https://www.pexels.com).*