...
1. **Start your EP application before you arrive** - employers apply on your behalf via EP Online (EPOL); you can only enter Singapore on a tourist pass while waiting for EP approval[^10]
2. **Use MOM's Self-Assessment Tool (SAT)** at mom.gov.sg before your employer submits - check your COMPASS score in advance[^49]
3. **Open a bank account immediately** - DBS, POSB, OCBC, and UOB are expat-friendly; most require your EP card + passport; Revolut works as a bridge
4. **Arrange health insurance** - don't rely solely on employer coverage; confirm what's covered, especially for hospitalisation and specialists[^33][^31]
5. **Get an EZ-Link card** for public transport (MRT + buses) - S$12 initial card, top up anywhere; monthly pass around S$128[^26]
6. **Find housing on PropertyGuru or 99.co** - budget 1-2 months' rent as deposit; short-term serviced apartments are available for the first 30-60 days while you find permanent housing[^8]
7. **Register your address with IRAS** after moving in - required for tax purposes
8. **Negotiate your relocation package hard**: housing allowance, school fees (international schools cost S$25,000-S$50,000/year), health insurance, and annual flights home are standard components for senior hires[^50]
