      ...
      <tr>
        <th className="p-3 text-center w-1/3">
          <div className="flex flex-col items-center gap-1 justify-center">
            {countryA.iso_alpha2 ? (
              <Image src={`/flags/moving-to-${countryA.slug}.png`} width={24} height={18} className="shadow-sm rounded-sm" alt={countryA.name} />
        ...
        <th className="p-3 text-center w-1/3">
          <div className="flex flex-col items-center gap-1 justify-center">
            {countryB.iso_alpha2 ? (
              <Image src={`/flags/moving-to-${countryB.slug}.png`} width={24} height={18} className="shadow-sm rounded-sm" alt={countryB.name} />
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl space-y-12 pb-24">
      ...
      <div className="flex justify-between items-center relative">
        <div className="w-1/3 flex flex-col items-center text-center">
          {countryA.iso_alpha2 ? (
            <div className="relative w-24 h-16 md:w-40 md:h-28 mb-4 shadow-lg rounded-xl overflow-hidden border border-white/10">
              <Image src={`/flags/moving-to-${countryA.slug}.png`} fill className="object-cover" alt={countryA.name} />
            </div>
        ...
        <div className="w-1/3 flex flex-col items-center text-center">
          {countryB.iso_alpha2 ? (
            <div className="relative w-24 h-16 md:w-40 md:h-28 mb-4 shadow-lg rounded-xl overflow-hidden border border-white/10">
              <Image src={`/flags/moving-to-${countryB.slug}.png`} fill className="object-cover" alt={countryB.name} />
            </div>
                    ...
                    {c.c.expats.slice(0, 5).map((e: any, j: number) => (
                      <div key={j} className="flex items-center justify-between">
                        <div className="flex items-center gap-2 truncate">
                          {e.origin_alpha2 ? (
                            <Image src={`/flags/moving-to-${e.origin_slug}.png`} width={16} height={12} className="rounded-sm object-cover" alt={e.name} />
